...
//   const pint = localStorage.getItem("postData")
    // const posts = JSON.parse(pint)
    ...
    if (!loading) {
            return (
                <div className='py-8  flex justify-center items-center text-center'>
                    <Container>
                    <div role="status">
        <svg aria-hidden="true" class="w-48 h-48 text-gray-200 animate-spin dark:text-gray-600 fill-yellow-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
